                                    ...
                                    <c:if test="${not empty pageContext.request.userPrincipal}">
                                        ...
                                        <div class="dropdown my-auto">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end p-4"
                                                ...
                                                <li><a class="dropdown-item" href="/seller">Trang dành cho người bán</a>
                                                </li>
                                                <li><a class="dropdown-item"
                                                        href="/client/user/update/${sessionScope.id}">Quản
                                                        lý tài khoản</a></li>
                                                <!-- <c:if test="${sessionScope.role eq 'ADMIN'}">
                                                    <li><a class="dropdown-item" href="/admin">Trang dành cho ADMIN</a>
                                                    </li>
                                                </c:if> -->
