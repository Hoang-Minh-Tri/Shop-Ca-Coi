                                            ...
                                            <div class="col-12" id="factoryFilter">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="factory-1"
                                                        value="Gosanke">
                                                    <label class="form-check-label" for="factory-1">Gosanke</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="factory-2"
                                                        value="Utsurimono">
                                                    <label class="form-check-label" for="factory-2">Utsurimono</label>
                                                </div>

                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="factory-3"
                                                        value="Hikarimono">
                                                    <label class="form-check-label" for="factory-3">Hikarimono</label>
                                                </div>

                                            </div>
                                            <div class="col-12" id="targetFilter">
                                                <div class="mb-2"><b>Xếp hạng</b></div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="target-1"
                                                        value="Loai 1">
                                                    <label class="form-check-label" for="target-1">Loai 1</label>
                                                </div>

                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="target-2"
                                                        value="Loai 2">
                                                    <label class="form-check-label" for="target-2">Loại 2</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="target-3"
                                                        value="Loai 3">
                                                    <label class="form-check-label" for="target-3">Loại 3</label>
                                                </div>
                                            </div>
                                            ...
                                            <c:if test="${sumPage > 0}">
                                                <div class="pagination d-flex justify-content-center mt-5">
                                                    <li class="page-item ${nowPage eq 1 ? 'disabled' : ''}">
                                                        <a class="page-link"
                                                            href="/products?page=${nowPage - 1}${queryString}"
                                                            aria-label="Previous">
