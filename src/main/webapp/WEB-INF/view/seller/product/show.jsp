                                    ...
                                    <div class="row">
                                        <div class="col-12 mx-auto">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <a href="/seller/product/create" class="btn btn-primary">Tạo sản phẩm
                                                    mới</a>
                                            </div>
                                                    ...
                                                    <ul class="pagination justify-content-center">
                                                        <li class="page-item">
                                                            <a class="${(nowPage) eq 1 ? 'disabled page-link' : 'page-link'}"
                                                                href="/seller/product?page=${nowPage - 1}"
                                                                aria-label="Previous">
                                                        ...
                                                        <c:forEach begin="0" end="${sumPage - 1}" varStatus="loop">
                                                            <li class="page-item ">
                                                                <a class="${(loop.index + 1) eq nowPage ? 'active page-link' : 'page-link'}"
                                                                    href="/seller/product?page=${loop.index+1}">
                                                                    ${loop.index+1}
                                                                </a>
                                                            </li>
                                                        </c:forEach>
